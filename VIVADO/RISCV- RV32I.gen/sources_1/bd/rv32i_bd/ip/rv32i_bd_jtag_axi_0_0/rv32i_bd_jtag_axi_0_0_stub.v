...
// Command     : write_verilog -force -mode synth_stub -rename_top rv32i_bd_jtag_axi_0_0 -prefix
//               rv32i_bd_jtag_axi_0_0_ rv32i_bd_jtag_axi_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "rv32i_bd_jtag_axi_0_0,jtag_axi_v1_2_23_jtag_axi,{}" *) (* CORE_GENERATION_INFO = "rv32i_bd_jtag_axi_0_0,jtag_axi_v1_2_23_jtag_axi,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=jtag_axi,x_ipVersion=1.2,x_ipCoreRevision=23,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,RD_TXN_QUEUE_LENGTH=1,WR_TXN_QUEUE_LENGTH=1,M_AXI_ID_WIDTH=1,M_AXI_ADDR_WIDTH=32,FAMILY=virtexu,M_AXI_DATA_WIDTH=32,M_HAS_BURST=1,PROTOCOL=2}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "jtag_axi_v1_2_23_jtag_axi,Vivado 2025.2" *) 
module rv32i_bd_jtag_axi_0_0(aclk, aresetn, m_axi_awaddr, m_axi_awprot, 
