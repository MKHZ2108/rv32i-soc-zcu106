...
// Command     : write_verilog -force -mode synth_stub -rename_top rv32i_bd_axi_uartlite_0_0 -prefix
//               rv32i_bd_axi_uartlite_0_0_ rv32i_bd_axi_uartlite_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "rv32i_bd_axi_uartlite_0_0,axi_uartlite,{}" *) (* core_generation_info = "rv32i_bd_axi_uartlite_0_0,axi_uartlite,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_uartlite,x_ipVersion=2.0,x_ipCoreRevision=39,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_S_AXI_ACLK_FREQ_HZ=100000000,C_S_AXI_ADDR_WIDTH=4,C_S_AXI_DATA_WIDTH=32,C_BAUDRATE=115200,C_DATA_BITS=8,C_USE_PARITY=0,C_ODD_PARITY=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_uartlite,Vivado 2025.2" *) 
module rv32i_bd_axi_uartlite_0_0(s_axi_aclk, s_axi_aresetn, interrupt, 
