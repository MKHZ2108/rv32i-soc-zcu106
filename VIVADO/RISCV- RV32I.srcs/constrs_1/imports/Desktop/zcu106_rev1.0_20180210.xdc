...
set_property PACKAGE_PIN G13      [get_ports "ext_reset_in_0"] ;# [get_ports "CPU_RESET"] ///// Bank  68 VCCO - VADJ_FMC - IO_T2U_N12_68
set_property IOSTANDARD  LVCMOS18 [get_ports "ext_reset_in_0"] ;# [get_ports "CPU_RESET"] /////  Bank  68 VCCO - VADJ_FMC - IO_T2U_N12_68
# G13 la chan FMC bank 68, KHONG co pull-down ngoai -> troi len 1 -> NOT -> 0 -> ext_reset_in
# (active-low) bi asserted mai -> aresetn ket = 0 -> AXI timeout. Bat pull-down noi de chan
# ve 0 khi khong nhan (nut nhan van drive 1 override duoc).
set_property PULLDOWN TRUE        [get_ports "ext_reset_in_0"]
...
set_property PACKAGE_PIN G9       [get_ports "clk_in1_n_0"] ;#  [get_ports "CLK_125_N"] /// Bank  68 VCCO - VADJ_FMC - IO_L11N_T1U_N9_GC_68
set_property IOSTANDARD  LVDS     [get_ports "clk_in1_n_0"] ;#  [get_ports "CLK_125_N"] /// Bank  68 VCCO - VADJ_FMC - IO_L11N_T1U_N9_GC_68
set_property PACKAGE_PIN H9       [get_ports "clk_in1_p_0"] ;#  [get_ports "CLK_125_P"] /// Bank  68 VCCO - VADJ_FMC - IO_L11P_T1U_N8_GC_68
set_property IOSTANDARD  LVDS     [get_ports "clk_in1_p_0"] ;#  [get_ports "CLK_125_P"] /// Bank  68 VCCO - VADJ_FMC - IO_L11P_T1U_N8_GC_68
# NOTE: KHONG can create_clock o day - clk_wiz_1 IP da tu tao create_clock -period 8.000
# tren clk_in1_p_0 (xem rv32i_bd_clk_wiz_1_0.xdc:53). Them o day gay override warning 18-1055.
...
# --- pll_locked debug: dua tin hieu PLL locked ra LED0 (Bank 66 = VCC1V2, luon co dien) ---
# LED SANG => PLL lock OK (clock 125MHz toi noi). LED TAT => PLL khong lock => clock nguon loi.
#set_property PACKAGE_PIN AL11     [get_ports "pll_locked"] ;# Bank  66 VCCO - VCC1V2   - IO_L8P_T1L_N2_AD5P_66
#set_property IOSTANDARD  LVCMOS12 [get_ports "pll_locked"] ;# Bank  66 VCCO - VCC1V2   - IO_L8P_T1L_N2_AD5P_66
...
set_property PACKAGE_PIN AK13     [get_ports "pll_locked"] ;# Bank  66 VCCO - VCC1V2   - IO_L7P_T1L_N0_QBC_AD13P_66
set_property IOSTANDARD  LVCMOS12 [get_ports "pll_locked"] ;# Bank  66 VCCO - VCC1V2   - IO_L7P_T1L_N0_QBC_AD13P_66
set_property PACKAGE_PIN AM8      [get_ports "peripheral_aresetn"] ;# Bank  66 VCCO - VCC1V2   - IO_L6N_T0U_N11_AD6N_66
set_property IOSTANDARD  LVCMOS12 [get_ports "peripheral_aresetn"] ;# Bank  66 VCCO - VCC1V2   - IO_L6N_T0U_N11_AD6N_66
set_property PACKAGE_PIN AM9      [get_ports "interconnect_aresetn"] ;# Bank  66 VCCO - VCC1V2   - IO_L6P_T0U_N10_AD6P_66
set_property IOSTANDARD  LVCMOS12 [get_ports "interconnect_aresetn"] ;# Bank  66 VCCO - VCC1V2   - IO_L6P_T0U_N10_AD6P_66
...
set_property PACKAGE_PIN AM11     [get_ports "clk_out"] ;# Bank  66 VCCO - VCC1V2   - IO_L5P_T0U_N8_AD14P_66
set_property IOSTANDARD  LVCMOS12 [get_ports "clk_out"] ;# Bank  66 VCCO - VCC1V2   - IO_L5P_T0U_N8_AD14P_66
...
set_property PACKAGE_PIN AH17      [get_ports "rx_0"] ;# Bank  64 VCCO - VCC1V2   - IO_L13N_T2L_N1_GC_QBC_64
set_property IOSTANDARD  LVCMOS12  [get_ports "rx_0"] ;# Bank  64 VCCO - VCC1V2   - IO_L13N_T2L_N1_GC_QBC_64
set_property PACKAGE_PIN AL17      [get_ports "tx_0"] ;# Bank  64 VCCO - VCC1V2   - IO_T1U_N12_64
set_property IOSTANDARD  LVCMOS12  [get_ports "tx_0"] ;# Bank  64 VCCO - VCC1V2   - IO_T1U_N12_64
